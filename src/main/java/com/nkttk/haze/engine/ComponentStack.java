...
import com.nkttk.haze.config.cf.resources.SNSResource;
import com.nkttk.haze.config.cf.resources.SQSResource;
import com.nkttk.haze.engine.component.event.BucketEventType;
import com.nkttk.haze.engine.component.lambda.LambdaBuilder;
import com.nkttk.haze.engine.component.lambda.LambdaEngine;
...
import com.nkttk.haze.engine.component.sns.SNSEngine;
import com.nkttk.haze.engine.component.sns.SNSTopic;
import com.nkttk.haze.engine.component.sqs.SQSEngine;
import com.nkttk.haze.engine.component.sqs.SQSInstance;
import com.nkttk.haze.engine.component.sqs.entities.SQSMessage;
import com.nkttk.haze.engine.factory.ClientFactory;
import com.nkttk.haze.engine.factory.ComponentFactory;
import com.nkttk.haze.engine.factory.SNSMessageFactory;
import com.nkttk.haze.engine.factory.SQSMessageFactory;
...
public class ComponentStack {
    ...
    public ComponentStack(ComponentFactory componentFactory, ClientFactory clientFactory) {
        ...
        this.FSContainer = new FSContainer(bucketName -> new Bucket(bucketName, objectName -> new FileObject(objectName)));
...
//        Bucket bucket = FSContainer.getBucket(bucketName);
//
//        FSContainer.addEventSubscription(bucket, BucketEventType.PUT, event -> {
//            String eventJson = JsonMaster.toString(EventBuilder.buildS3Notification(eventType, bucket.getName(), bucket
//                    .getUrl(), event.getFileObject().getKey(), event.getFileObject().getSize(), event.getFileObject()
//                    .getEtag()));
...
//        FSContainer.addFile(bucket, name, content);
...
//        FileObject bucketObject = FSContainer.getBucket(bucket).orElseThrow(() -> new RuntimeException("No bucket found : " + bucket)).getFile(file);
