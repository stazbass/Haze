...
/**
 * Custom s3 client implementation, proxy calls into provided FSContainer (s3-fs component into component container)
 */
public class HazeS3 implements AmazonS3 {
    FSContainer fsEngine;

    public HazeS3(FSContainer engine) {
        fsEngine = engine;
    }
